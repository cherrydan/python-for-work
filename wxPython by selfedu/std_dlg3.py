...
class MyFrame(wx.Frame):
    def __init__(self, parent, title):
        ...
        file_menu.Append(wx.ID_SAVEAS, '&Сохранить как...\tCtrl+S')
    ...
    def on_new(self, event):
        dlg = wx.TextEntryDialog(self, 'Введите имя', 'Ввод данных',
                                 'abcdefgh')
    ...
    def on_open(self, event):
        with wx.FileDialog(self, 'Открыть файл', wildcard='Файлы скриптов (*.py) |*.py',
    ...
    def on_save_as(self, event):
        with wx.FileDialog(self, 'Сохранить файл как', wildcard='Файлы скриптов (*.py) |*.py',
